...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: (theme) => ({
      ...
      "sm-image-technology": "url('/assets/technology/background-technology-mobile.jpg')",
      "md-image-technology": "url('/assets/technology/background-technology-tablet.jpg')",
      "lg-image-technology": "url('/assets/technology/background-technology-desktop.jpg')",
    }),
  },
  plugins: [],
};
